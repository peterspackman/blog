---
slug: MO_rotation
title: Rotating molecular orbital coefficients
authors: [prs]
tags: [qm,molecular orbitals,linear algebra]
---

If you're a masochist like me, you'll want to rotate molecular orbital coefficients
...
but of course you're welcome to double the pain and mix in rotations about arbitrary points in space.

But first we need a quick refresher on the difference between Cartesian and Spherical/Pure basis sets.
Note that throughout this I'm going to ignore different normalizations within contracted Gaussians,
because frankly that just makes the equations more verbose...
...
where $K$ is the degree of contraction (i.e. number of primitive basis functions),
...
$$
S(i_1, j_1, k_1, i_2, j_2, k_2) = \frac{(i_1 + i_2)! (j_1 + j_2)! (k_1 + k_2)!}{((i_1 + i_2)/2)! ((j_1 + j_2)/2)! ((k_1 + k_2)/2)!} \sqrt{\frac{i_1 ! j_1 ! k_1 ! i_2 ! j_2 ! k_2 !}{(2 i_1)! (2 j_1)! (2 k_1)! (2 i_2)! (2 j_2)! (2 k_2)!}}
$$
